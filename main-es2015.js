...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<!-- This is just a place holder to show that the navigation is properly setup. -->\n<div class=\"page-display-container\">\n  <h1>PRODUCTS</h1>\n\n  <p>\n    You are welcome to the Products page.\n    Please follow navigation menu for other options.\n  </p>\n\n</div>\n");
...
/* harmony import */ var _components_schedules_schedules_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/schedules/schedules.component */ "./src/app/components/schedules/schedules.component.ts");
/* harmony import */ var _components_library_library_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/library/library.component */ "./src/app/components/library/library.component.ts");
...
const routes = [
    ...
    { path: 'products', component: _components_schedules_schedules_component__WEBPACK_IMPORTED_MODULE_5__["SchedulesComponent"] },
    { path: 'contacts', component: _components_contact_us_contact_us_component__WEBPACK_IMPORTED_MODULE_7__["ContactUsComponent"] },
    { path: 'libraries/:libraryId', component: _components_library_library_component__WEBPACK_IMPORTED_MODULE_6__["LibraryComponent"] },
    { path: 'home', redirectTo: '' },
    { path: '**', pathMatch: 'full', component: _components_page_not_found_page_not_found_component__WEBPACK_IMPORTED_MODULE_4__["PageNotFoundComponent"] }
];
...
/* harmony import */ var _components_schedules_schedules_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./components/schedules/schedules.component */ "./src/app/components/schedules/schedules.component.ts");
/* harmony import */ var _components_library_library_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./components/library/library.component */ "./src/app/components/library/library.component.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [
            ...
            _components_schedules_schedules_component__WEBPACK_IMPORTED_MODULE_8__["SchedulesComponent"],
            _components_library_library_component__WEBPACK_IMPORTED_MODULE_9__["LibraryComponent"],
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var src_app_services_endpoints_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/app/services/endpoints.service */ "./src/app/services/endpoints.service.ts");
...
let HomeComponent = class HomeComponent {
    ...
    constructor(endpointsService, router) {
        this.endpointsService = endpointsService;
        this.router = router;
    }
    // Setting up the form validation
    ngOnInit() {
        this.endpointsService.getLibraries().subscribe((libraries) => {
            this.libraries = libraries;
        });
    }
    getSelectedLibrary(libraryId) {
        const id = libraryId.toString();
        this.endpointsService.getALibrary(id).subscribe((library) => {
            this.currentSelectedLibrary = library;
            console.log(library);
            this.router.navigate(['/libraries', id], { state: { data: library } });
        });
    }
};
...
let LibraryComponent = class LibraryComponent {
    constructor(endpointsService, route, dialog) {
        this.endpointsService = endpointsService;
        this.route = route;
        this.dialog = dialog;
    ...
    ngOnInit() {
        const routeP = this.route.snapshot.params.libraryId;
        this.library = history.state.data;
        this.endpointsService.subsricption.subscribe((lib) => {
            this.library = lib;
        });
        this.endpointsService.getALibrary(routeP).subscribe((library) => {
            this.library = library;
            // this.isGetAvailableBooks = false;
        });
    }
    getAvailableBooks(id) {
        this.isGetAvailableBooks = true;
        this.endpointsService.getAvailableBooks(id).subscribe((bookObjects) => {
            this.availableBooks = bookObjects;
        });
    }
    displaySelectedBookDetails(templateRef, bookObj) {
...
LibraryComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./library.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/library/library.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./library.component.scss */ "./src/app/components/library/library.component.scss")).default]
    })
], LibraryComponent);
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
/* harmony import */ var src_app_services_endpoints_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/services/endpoints.service */ "./src/app/services/endpoints.service.ts");
...
let NavBarComponent = class NavBarComponent {
    ...
    constructor(router, endpointsService) {
        this.router = router;
        this.endpointsService = endpointsService;
        this.mobileMenuOpen = false; // Keeps the mobile devices menu closed until triggered
        this.selectedLibrary = { name: 'Toronto Public Library' }; // Initializes the selected library
    ...
    loadSelectedLibrary(libraryId) {
        const id = libraryId.toString();
        this.endpointsService.getALibrary(id).subscribe((library) => {
            if (this.router.url.split('/')[1] === 'libraries') {
                this.endpointsService.setSelectedLibrary(library);
...
SchedulesComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./schedules.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/schedules/schedules.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./schedules.component.scss */ "./src/app/components/schedules/schedules.component.scss")).default]
    })
], SchedulesComponent);
...
EndpointsService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
];
EndpointsService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
module.exports = __webpack_require__(/*! D:\other-projects\akanm\src\main.ts */"./src/main.ts");
